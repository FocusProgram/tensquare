...
public class ReplyController {
	...
	public Result queryReplyById(@PathVariable String userid,@PathVariable int page,@PathVariable int size){
		Page<Reply> replyPage = replyService.queryReplyById(userid,page,size);
		return new Result(true,StatusCode.OK,"查询成功",new PageResult<>(replyPage.getTotalElements(),replyPage.getContent()));
	}
